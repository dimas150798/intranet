...
class DataPeminjamanBarangPegawai extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/DataPeminjaman/dataPeminjamanBarangPegawai', $data);
    ...
    public function detailPeminjaman($id)
    {
        ...
        $this->load->view('template/header', $data);
        $this->load->view('template/sidebarUser', $data);
        $this->load->view('user/DataPeminjaman/detailPeminjamanBarang', $data);
        $this->load->view('template/footer', $data);
    }
    ...
    public function deleteData($id)
    {
        ...
        redirect('user/DataPeminjaman/DataPeminjamanBarangPegawai');
    }
}
