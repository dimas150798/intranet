...
class PengembalianBarang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/DataPeminjaman/pengembalianBarang', $data);
    ...
    public function pengembalianBarang($id)
    {
        ...
        $this->load->view('user/DataPeminjaman/pengembalianBarang');
    ...
    public function addData()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('template/header', $data);
            $this->load->view('template/sidebarUser', $data);
            $this->load->view('user/DataPeminjaman/addPeminjamanBarang', $data);
            $this->load->view('template/footer', $data);
        } else {
            ...
            if ($jumlah == 0) {
                ...
                redirect('user/DataPeminjaman/DataPeminjamanBarang');
            }
        }
    }
}
