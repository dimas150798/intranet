...
class Add_StockKeluarATK extends CI_Controller
{
    ...
    public function addStockKeluar($id)
    {
        ...
        $this->load->view('admin/DataBarangV2/add_StockKeluarATK', $data);
        $this->load->view('template/footer', $data);
    }

    // data keluar ATK
    public function addStockKeluarATK()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($id_pegawai == null && $tanggal == null) {
                ...
                redirect('admin/DataBarangV2/Data_StockBarangATK');
            }
        }
    }
}
