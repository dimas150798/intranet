...
class Add_StockKeluarEngineer extends CI_Controller
{
    ...
    public function addStockKeluar($id)
    {
        ...
        // $checkKodeBarang = $this->BarangModelV2->getKodeBarang($id);

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebarAdmin', $data);
        $this->load->view('admin/DataBarangV2/add_StockKeluarEngineer', $data);
        $this->load->view('template/footer', $data);
    }

    // data keluar ATK
    public function addStockKeluarEngineer()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($jumlahNow == 0) {
                ...
                if ($kode_barang == null && $kode_barang == 0) {
                    ...
                    redirect('admin/DataBarangV2/Data_StockBarangEngineer');
                }
            }
        }
    }
