...
class DataBarangRestock extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['dataBarang'] = $this->BarangModel->dataBarangRestock($tanggalAwal, $tanggalAkhir);

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebarAdmin', $data);
        $this->load->view('admin/DataBarang/dataBarangRestock', $data);
