...
class MutasiBarangModemPusat extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/DataBarang/mutasiBarangModemPusat', $data);
    ...
    public function mutasiDataAksi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('admin/DataBarang/mutasiBarangModemPusat');
            ...
            $checkDuplicateSN = $this->BarangModel->checkDuplicateSN($id, $SN);

            if ($checkDuplicateSN->id_barang == $id && $checkDuplicateSN->SN == $SN) {
                echo "
                        <script>
                        alert('SN Sudah Digunakan');history.go(-1)
                ...
                redirect('admin/DataBarang/DataBarangModemPusat');
            }
        }
    }
}
