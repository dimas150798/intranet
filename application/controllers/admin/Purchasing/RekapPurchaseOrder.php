...
class RekapPurchaseOrder extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['dataOrder'] = $this->PurchasingModel->dataRekapOrder($tanggalAwal, $tanggalAkhir);

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebarAdmin', $data);
        $this->load->view('admin/Purchasing/rekapPurchaseOrder', $data);
