...
class DataPurchaseRequest extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['dataRequest'] = $this->PurchasingModel->dataRequest($tanggalAwal, $tanggalAkhir);

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebarAdmin', $data);
        $this->load->view('admin/DataPurchase/dataPurchasingRequest', $data);
