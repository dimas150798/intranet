...
class EditCustomerKBS extends CI_Controller
{
    ...
    {
        $data['dataCustomerKBS'] = $this->CustomerModel->dataCustomerKBS();
        $data['dataPaket'] = $this->CustomerModel->dataPaket();
        $data['dataKotKab'] = $this->CustomerModel->dataKotKab();

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebarAdmin', $data);
        $this->load->view('admin/DataCustomer/editCustomerKBS', $data);
        $this->load->view('template/footer', $data);
    }

    public function editData($id)
    {
        $data['dataCustomer']  =  $this->db->query("SELECT data_customer_kbs.id_customer,data_customer_kbs.pembelian_paket,data_customer_kbs.nama_customer,       
            data_customer_kbs.nik_customer,data_customer_kbs.alamat_customer,data_customer_kbs.tlp_customer,data_customer_kbs.id_wilayah,data_customer_kbs.SN, data_customer_kbs.id_kota, data_customer_kbs.id_kecamatan, data_customer_kbs.id_kelurahan,
            ...
            WHERE data_customer_kbs.id_customer  = '$id'")->result();
    ...
    public function editDataAksi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('admin/DataCustomer/editCustomerKBS');
            ...
            $this->CustomerModel->updateData('data_customer_kbs', $data, $where);
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
                  <strong>UPDATE DATA BERHASIL</strong>
                  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>');
            redirect('admin/DataCustomer/DataCustomerKBS');
        }
    }
}
