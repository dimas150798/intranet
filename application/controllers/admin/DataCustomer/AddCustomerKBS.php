...
class AddCustomerKBS extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/DataCustomer/addCustomerKBS', $data);
    ...
    public function addData()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $checkDuplicateCustomerKBS = $this->CustomerModel->checkDuplicateCustomerKBS($nama_customer, $nik_customer);

            if ($checkDuplicateCustomerKBS->nama_customer || $nama_customer && $checkDuplicateCustomerKBS->nik_customer == $nik_customer) {
                echo "
                        <script>
                ...
                $this->CustomerModel->insertData($data, 'data_customer_kbs');
