<div id="layoutSidenav_content">
   <main>
      ...
      <div class="container-fluid px-4">
         ...
         <h4 class="mt-4">Data Barang Rusak Keluar</h4>
         ...
         <div class="card mb-4">
            ...
            <div class="card-body">
               <div class="container">
                  ...
                  <form method="POST"
                     action="<?php echo base_url('admin/DataBarangV2/Add_StockKeluarBarangRusak/addStockKeluarBarang') ?>"
                     ...
                     <div class="row justify-content-center">
                        ...
                        <input type="hidden" class="form-control" name="jumlahRusak" id="jumlahRusak"
                           value="<?php echo $data->jumlah_stockRusak ?>"
                           placeholder="Masukkan jumlah...">
                     ...
                     <div class="row justify-content-center">
                        ...
                        <div class="col-sm-4 mt-3">
                           ...
                           <select name="kodeBarang" id="kodeBarang" class="form-control" required>
                              <option disabled selected>-- Pilih SN --</option>
                              <?php foreach ($dataSN as $modem) : ?>
                              <option
                                 value="<?php echo $modem['kode_barang']?>">
                                 <?php echo $modem['kode_barang']?>
                              </option>
                              <?php endforeach; ?>
                           </select>
                        </div>
