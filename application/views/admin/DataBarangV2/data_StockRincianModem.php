...
<div id="layoutSidenav_content">
	<main>
		...
		<div class="container">
			<h4 class="mt-4" style="margin-left: 5px; margin-right: 5px;">Detail Barang Gudang Modem</h4>
								...
								<td class="text-center">
                                    ...
                                    href="<?php echo base_url('admin/DataBarangV2/Edit_StockRincianModem/editData/' . $data['id_stockRincian']) ?>"><i
											...
											<a onclick="return confirm('Yakin Menghapus Data')"
												...
												href="<?php echo base_url('admin/DataBarangV2/Data_StockRincianModem/deleteData/' . $data['id_stockRincian']) ?>"><i
