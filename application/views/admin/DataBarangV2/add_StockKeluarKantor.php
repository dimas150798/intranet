			...
			<div class="card mb-4">
				...
				<div class="card-body">
					<div class="container">
						...
						<form method="POST"
							action="<?php echo base_url('admin/DataBarangV2/Add_StockKeluarKantor/addStockKeluarKantor') ?>"
							...
							<div class="row justify-content-center">
								...
								<div class="col-sm-4 mt-3">
									<label for="jumlah" class="form-label" style="font-weight: bold;"> Jumlah :
										<span class="text-danger">*</span></label>
									<input type="number" class="form-control text-center bg-warning fw-bold"
