					...
					<table class="table table-bordered" id="datatablesSimple" width="100%">
						<thead>
							<tr>
								...
								<th width="5%" class="text-center">Jumlah Rusak</th>
                        ...
                        ?>
                            ...
                            echo $data['jumlah_stockMutasi'];
								...
								<td class="text-center">
									<?php if ($data['jumlah_stockRusak'] == null) {
                            echo "0";
                        } else {
                            echo $data['jumlah_stockRusak'];
                        }?>
								</td>
								<td class="text-center">
								...
								<td class="text-center">
									<div class="btn-group">
										...
										<div class="dropdown-menu text-black" style="background-color:aqua;">
											...
											<a class="dropdown-item text-black"
												href="<?php echo base_url('admin/DataBarangV2/Add_StockKeluarBarangRusak/addStockKeluar/' . $data['id_barang']) ?>"><i
													class="bi bi-dash-lg"></i> Keluar Barang Rusak</a>
											<a class="dropdown-item text-black"
