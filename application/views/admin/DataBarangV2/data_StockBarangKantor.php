...
<div id="layoutSidenav_content">
	<main>
		...
		<div class="container">
			<h4 class="mt-4" style="margin-left: 5px; margin-right: 5px;">Peralatan Kantor</h4>
                            ...
                            echo changeDateFormat('d-m-Y', $data['tanggal_mutasi']);
								...
								<td class="text-center">
									<a class="btn btn-sm btn-warning"
										href="<?php echo base_url('admin/DataBarangV2/Add_StockRincianKantor/addStockRincian/' . $data['id_stockBarang']) ?>"><i
											class="bi bi-clipboard2-plus-fill"></i></a>
									<a class="btn btn-sm btn-primary"
										href="<?php echo base_url('admin/DataBarangV2/Add_StockKeluarKantor/addStockKeluar/' . $data['id_barang']) ?>"><i
