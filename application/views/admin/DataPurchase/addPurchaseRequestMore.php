         ...
         <div class="card mb-4">
            ...
            <div class="card-body">
               <div class="container">
                  ...
                  <form method="POST"
                     action="<?php echo base_url('admin/DataPurchase/AddPurchaseRequestMore/addDataMore') ?>">
                     ...
                     <div class="row justify-content-center">
                        ...
                        <div class="col-sm-4 mt-3">
                           ...
                           <input type="text" class="form-control text-center bg-warning fw-bold" name="nama_pegawai"
                              id="nama_pegawai"
                     ...
                     <div class="row mt-3">
                        <div class="col-sm-12 d-flex justify-content-end">
                           ...
                           <a onclick="return confirm('Selesaikan Purchase Request')"
                              class="btn btn-danger mt-2 justify-content-end"
                              href="<?php echo base_url('admin/DataPurchase/DataPurchaseRequest') ?>"><i
                                 class="bi bi-check-circle"></i> Selesai</a>
                        </div>
                     </div>
