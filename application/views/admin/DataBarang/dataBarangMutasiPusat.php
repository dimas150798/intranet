<div id="layoutSidenav_content">
	<main>
		...
		<div class="card mb-3 mt-2" style="margin-bottom: 10px; margin-left: 5px; margin-right: 5px;">
			...
			<h4 class="mt-4" style="margin-left: 18px; margin-right: 5px;">Data Barang Mutasi</h4>
			<ol class="breadcrumb" style="margin-bottom: 10px; margin-left: 18px; margin-right: 5px;">
				<li class="breadcrumb-item"><a href="#">Data Barang Mutasi</a></li>
				<li class="breadcrumb-item active">Tables</li>
			</ol>

			<div class="card-body">
				<form method="POST"
					action="<?php echo base_url('admin/DataBarang/DataBarangMutasiPusat/index') ?>">
					...
					<div class="row">
						...
						<div class="col-md-8 mt-auto justify-content-end d-flex">
							...
							<a class="btn btn-success mt-2 justify-content-end"
								href="<?php echo base_url('admin/DataBarang/DataBarangMutasiModemPusat') ?>"
								style="margin-left: 5px;"><i class="bi bi-modem"></i> Modem</a>
						...
						<tr>
							...
							<td class="text-center">
								<a onclick="return confirm('Yakin Menghapus Data')" class="btn btn-sm btn-danger"
									href="<?php echo base_url('admin/DataBarang/DataBarangMutasiPusat/deleteData/' . $data['id_barang_mutasi']) ?>"><i
