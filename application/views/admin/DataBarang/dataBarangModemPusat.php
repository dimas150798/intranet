<div id="layoutSidenav_content">
	<main>
		...
		<div class="container">
			<h4 class="mt-4" style="margin-left: 5px; margin-right: 5px;">Data Barang Modem Pusat</h4>
			<ol class="breadcrumb mb-4" style="margin-bottom: 10px; margin-left: 5px; margin-right: 5px;">
				<li class="breadcrumb-item"><a href="#">Data Barang Modem Pusat</a></li>
			...
			<div id="kwitansiClose" class="card" style="margin-bottom: 10px; margin-left: 5px; margin-right: 5px;">
				<div id="kwitansiClose" class="card-header">
					...
					<a class="btn btn-primary mt-2 ml-auto"
						href="<?php echo base_url('admin/DataBarang/DataBarangPusat') ?>"
						style="margin-top: 10px;"><i class="bi bi-box-seam-fill"></i> Data Barang</a> <br>
                            ...
                            ?>
								...
								<td class="text-center">
									...
									<a class="btn btn-sm btn-warning"
										href="<?php echo base_url('admin/DataBarang/MutasiBarangModemPusat/mutasiBarang/' . $data['id_barang']) ?>"><i
