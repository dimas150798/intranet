<div id="layoutSidenav_content">
	<main>
		...
		<div class="card mb-3 mt-2" style="margin-bottom: 10px; margin-left: 5px; margin-right: 5px;">
			...
			<h4 class="mt-4" style="margin-left: 18px; margin-right: 5px;">Data Barang Masuk</h4>
			...
			<div class="card-body">
				<form method="POST"
					action="<?php echo base_url('admin/DataBarang/DataBarangRestock/index') ?>">
				...
				<table class="table table-bordered" id="datatablesSimple" width="100%">
					<thead>
						<tr>
							...
							<th width="10%" class="text-center">Jumlah Restock</th>
						</tr>
					</thead>
					<tbody>
						<?php $no = 1;
