						...
						<div class="row">
							...
							<div class="col-md-8 mt-auto justify-content-end d-flex">
								...
								<a class="btn btn-primary mt-2 justify-content-end"
									href="<?php echo base_url('admin/DataPeminjaman/DataPeminjamanBarang') ?>"
									style="margin-left: 5px;"><i class="bi bi-box-seam"></i> Data Peminjaman</a>
								<a class="btn btn-success mt-2 justify-content-end"
									href="<?php echo base_url('admin/DataPeminjaman/AddPeminjamanBarangPegawai') ?>"
									...
									<div class="btn-group">
										...
										<div class="dropdown-menu text-black" style="background-color:aqua;">
											<a class="dropdown-item text-black"
												href="<?php echo base_url('admin/DataPeminjaman/DataPeminjamanBarangPegawai/detailPeminjaman/' . $data['id_bukti_barang_peminjaman']) ?>"><i
													class="bi bi-eye"></i> Detail Data</a>
											<a class="dropdown-item text-black"
												href="<?php echo base_url('admin/DataPeminjaman/AddPengembalianBarangPegawai/addPengembalian/' . $data['id_bukti_barang_peminjaman']) ?>"><i
													class="bi bi-check-all"></i> Pengembalian</a>
											<a onclick="return confirm('Yakin Menghapus Data')"
												class="dropdown-item text-black"
												href="<?php echo base_url('admin/DataPeminjaman/DataPeminjamanBarangPegawai/deleteData/' . $data['id_bukti_barang_peminjaman']) ?>"><i
