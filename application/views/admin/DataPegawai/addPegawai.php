         ...
         <div class="card mb-4">
            ...
            <div class="card-body">
               <div class="container">
                  ...
                  <form method="POST"
                     action="<?php echo base_url('admin/DataPegawai/AddPegawai/addData') ?>"
                     enctype="multipart/form-data">

                     <div class="row justify-content-center">
                        <div class="col-sm-4 mt-2">
                           <label for="nama_pegawai" class="form-label" style="font-weight: bold;"> Nama : <span
                                 class="text-danger">*</span></label>
                           <input type="hidden" class="form-control" name="id_pegawai" id="id_pegawai" value=""
                              readonly>
                        ...
                        <div class="col-sm-4 mt-2">
                           <label for="NIK" class="form-label" style="font-weight: bold;"> No Induk Karyawan : <span
                                 class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-4 mt-2">
                           <label for="no_telpon" class="form-label" style="font-weight: bold;">No Telepon : <span
                                 class="text-danger">*</span></label>
                           <input type="number" class="form-control" name="no_telpon" id="no_telpon" value=""
                     ...
                     <div class="row justify-content-center">
                        <div class="col-sm-4 mt-2">
                           <label for="alamat_pegawai" class="form-label" style="font-weight: bold;"> Alamat : <span
                                 class="text-danger">*</span></label>
                           <input type="text" class="form-control" name="alamat_pegawai" id="alamat_pegawai" value=""
                        ...
                        <div class="col-sm-4 mt-2">
                           <label for="pendidikan_pegawai" class="form-label" style="font-weight: bold;">Pendidikan :
                              <span class="text-danger">*</span></label>
                           <select name="pendidikan_pegawai" id="pendidikan" class="form-control text-center" required>
                     ...
                     <div class="row justify-content-center">
                        <div class="col-sm-4 mt-2">
                           <label for="tanggal_masuk" class="form-label" style="font-weight: bold;"> Tanggal Masuk :
                              <span class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-4 mt-2">
                           <label for="gaji" class="form-label" style="font-weight: bold;">Gaji : <span
                                 class="text-danger">*</span></label>
                           <input type="text" class="form-control" name="gaji" id="gaji" value=""
                        ...
                        <div class="col-sm-4 mt-2">
                           <label for="photo" class="form-label" style="font-weight: bold;">Foto : <span
                                 class="text-danger">*</span></label>
