<div id="layoutSidenav_content">
	<main>
		...
		<div class="card mb-3 mt-2" style="margin-bottom: 10px; margin-left: 5px; margin-right: 5px;">
			...
			<div class="card-body">
				<form method="POST"
					action="<?php echo base_url('admin/Purchasing/DataPurchaseOrder/index') ?>">
				...
				<table class="table table-bordered" id="datatablesSimple" width="100%">
					<thead>
						<tr>
							...
							<th width="10%" class="text-center">No Reff</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<?php echo $data['quantinty']?>
							</td>

							<td class="text-center">
								<?php echo number_format($data['sub_total'], 0, ',', '.')?>
							</td>
