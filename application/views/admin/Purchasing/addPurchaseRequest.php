			...
			<div class="card mb-4">
				...
				<div class="card-body">
					<div class="container">
						...
						<form method="POST"
							action="<?php echo base_url('admin/Purchasing/AddPurchaseRequest/addData') ?>">
							...
							<div class="row mt-3">
								<div class="col-sm-12 d-flex justify-content-end">
									<button type="submit" id="tombol"
										onclick="Swal('Hello World','Latihan Alert', 'success')"
										class="btn btn-success mt-2 justify-content-end" style="margin-right: 5px;"><i
											class="bi bi-plus-circle"></i> Simpan</button>
