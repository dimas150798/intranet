<div id="layoutSidenav_content">
   <main>
      ...
      <div class="card mb-3 mt-2" style="margin-bottom: 10px; margin-left: 5px; margin-right: 5px;">
         ...
         <h4 class="mt-4" style="margin-left: 18px; margin-right: 5px;">Rekap Purchase Request</h4>
         <ol class="breadcrumb" style="margin-bottom: 10px; margin-left: 18px; margin-right: 5px;">
            <li class="breadcrumb-item"><a href="#">Rekap Data Purchase Request</a></li>
            <li class="breadcrumb-item active">Tables</li>
         </ol>

         <div class="card-body">
            <form method="POST"
               action="<?php echo base_url('admin/Purchasing/RekapPurchaseRequest/index') ?>">
                        ...
                        <div class="btn-group">
                           ...
                           <div class="dropdown-menu text-black" style="background-color:aqua;">
                              <a class="dropdown-item text-black"
                                 href="<?php echo base_url('admin/Purchasing/AccPurchaseOrder/accRequest/' . $data['id_purchasing_request']) ?>"><i
                                    class="bi bi-eye-fill"></i> Detail Request</a>
                              <a class="dropdown-item text-black"
                                 href="<?php echo base_url('admin/Purchasing/DiterimaPurchaseOrder/diterimaOrder/' . $data['id_purchasing_request']) ?>"><i
