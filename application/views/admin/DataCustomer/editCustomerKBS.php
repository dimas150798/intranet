                     ...
                     <ol class="breadcrumb mb-4">
                        ...
                        <div class="card mb-4">
                           ...
                           <div class="card-body">
                              ...
                              <form method="POST" action="<?php echo base_url('admin/DataCustomer/EditCustomerKBS/editDataAksi') ?>" enctype="multipart/form-data">
                                 ...
                                 <div class="row justify-content-center">
                                    <div class="col-sm-3 mt-2">
                                       ...
                                       <input type="text" class="form-control" name="nama_customer" id="nama_customer" value="<?php echo $data->nama_customer?>" placeholder="Masukkan nama...">
                                       <div class="bg-danger">
                                    ...
                                    <div class="col-sm-3 mt-2">
                                       ...
                                       <input type="number" class="form-control" name="nik_customer" id="nik_customer" value="<?php echo $data->nik_customer?>" placeholder="Masukkan NIK...">
                                       <div class="bg-danger">
                                    ...
                                    <div class="col-sm-3 mt-2">
                                       ...
                                       <input type="number" class="form-control" name="tlp_customer" id="tlp_customer" value="<?php echo $data->tlp_customer?>" placeholder="Masukkan telephon...">
                                       <div class="bg-danger">
                                 ...
                                 <div class="row justify-content-center">
                                    ...
                                    <div class="col-sm-6 mt-2">
                                       ...
                                       <input type="text" class="form-control" name="alamat_customer" id="alamat_customer" value="<?php echo $data->alamat_customer?>" placeholder="Masukkan alamat...">
                                       <div class="bg-danger">
                                    ...
                                    <div class="col-sm-6 mt-2">
                                       ...
                                       <select name="kota" id="kota" class="form-control text-center" required>
                                          ...
                                          <?php foreach ($dataKotKab as $datakotkab) : ?>
                                             <option value="<?php echo $datakotkab->id_kota; ?>" <?=$data->id_kota == $datakotkab->id_kota ? 'selected' : null?>><?php echo $datakotkab->nama_kota;?></option>
                                          <?php endforeach; ?>
                                       </select>
                                    </div>
                                 </div>
